...
#   /mnt/customers/aeiou.now/scripts/hourly-export.sh
#
...
#    - author/committer 用 **repo local git config**(/mnt/customers/aeiou.now 已設 weiqi-kids <lightman.chang@gmail.com>)
...
REPO="${AEIOU_REPO:-/mnt/customers/aeiou.now}"   # 可覆寫僅為了在複本上做端到端演練;cron 用預設值
