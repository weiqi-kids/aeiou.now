# Ghost festivals, Setsubun, and Halloween

## meta
- slug: protection-and-play
- canonical: Ghost Festivals, Setsubun, and Halloween
- category: community
- perennial: no
- commonality: giving stories about spirits, danger, and misfortune a place in seasonal rites and neighbourhood play
...
鬼節：鬼月、中元與節分
### summary
鬼月、中元、節分和萬聖節都會碰到「看不見的東西」或驅邪的想像，但做法不能混成同一種鬼節。普渡、撒豆、裝扮與要糖，分別把敬畏、祈求平安和鄰里遊戲放在不同位置。
### keywords
鬼月, 中元節, 節分, 萬聖節, 驅邪
...
Ghost Festivals, Setsubun, and Halloween
### summary
Ghost Month, Zhongyuan, Setsubun, and Halloween all give stories about spirits and danger a place in the calendar, but they do different work. Offerings, beans, costumes, and trick-or-treating range from rites for the dead and wishes for safety to neighbourhood play.
### keywords
...
鬼月・中元・節分・ハロウィン
### summary
鬼月、中元、節分、ハロウィンはいずれも、霊や災いについての物語を季節の行事に置く。ただし、供え物、豆まき、仮装、菓子配りは、先祖を供養する儀礼から近所の遊びまで役割が違う。
### keywords
鬼月, 中元, 節分, ハロウィン, 厄除け
### customs TW ghost-month
...
鬼节：鬼月、中元、节分与万圣节
### summary
鬼月、中元、节分和万圣节都会把关于鬼、灾祸或驱邪的故事放进季节日历，但它们承担的作用不同。祭品、撒豆、装扮和讨糖，从祭祀亡者、祈求平安到邻里游戏，各有自己的位置。
### keywords
鬼节, 鬼月, 中元节, 节分, 万圣节
### customs TW ghost-month
...
### summary
Ghost Month, Zhongyuan, Setsubun और Halloween में आत्माओं, डर या बुरी किस्मत की कहानियाँ आती हैं, लेकिन इनके काम अलग हैं। कहीं भेंट और पूजा है, कहीं बुराई दूर करने की रस्म, और कहीं पोशाक पहनकर पड़ोस में खेलना।
### keywords
...
### summary
Ghost Month, Zhongyuan, Setsubun, dan Halloween sama-sama memberi ruang bagi cerita tentang roh, bahaya, atau kesialan, tetapi perannya berbeda. Persembahan, lempar kacang, kostum, dan meminta permen bergerak dari ritual untuk orang meninggal dan doa keselamatan sampai permainan lingkungan.
### keywords
...
### summary
O Mês dos Fantasmas, o Zhongyuan, o Setsubun e o Halloween colocam histórias sobre espíritos, perigo ou azar no calendário, mas não fazem a mesma coisa. Oferendas, feijão, fantasias e doces podem pertencer a ritos para os mortos, pedidos de proteção ou brincadeiras de vizinhança.
### keywords
