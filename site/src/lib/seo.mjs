...
export const SEO_COPY = {
  'zh-TW': {
    answers: '快速回答', what: '這個主題是什麼？', when: '什麼時候？', where: '各地怎麼過？',
  ...
  en: {
    answers: 'Quick answers', what: 'What is this topic?', when: 'When is it?', where: 'How do places mark it?',
  ...
  ja: {
    answers: '要点', what: 'このテーマは何？', when: 'いつ？', where: '各地ではどう過ごす？',
  ...
  'zh-CN': {
    answers: '快速回答', what: '这个主题是什么？', when: '什么时候？', where: '各地怎么过？',
  ...
  hi: {
    answers: 'त्वरित उत्तर', what: 'यह विषय क्या है?', when: 'यह कब होता है?', where: 'अलग जगहों पर इसे कैसे मनाते हैं?',
  ...
  id: {
    answers: 'Jawaban singkat', what: 'Apa tema ini?', when: 'Kapan?', where: 'Bagaimana tempat berbeda menjalaninya?',
  ...
  'pt-BR': {
    answers: 'Respostas rápidas', what: 'O que é este tema?', when: 'Quando acontece?', where: 'Como lugares diferentes o vivenciam?',
